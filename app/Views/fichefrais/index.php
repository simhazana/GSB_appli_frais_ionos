...
<body>
    ...
    <a class="button" href="/index.php/fichefrais/create">➕ Ajouter un frais forfait</a>
            ...
            <tbody>
                <?php foreach ($ficheFrais as $fiche): ?>
                    <tr>
                        ...
                        <td class="actions">
    <a href="/index.php/fichefrais/<?= urlencode($fiche['idVisiteur']) ?>/<?= urlencode($fiche['mois']) ?>">Voir</a>
    
    <form action="/index.php/fichefrais/<?= urlencode($fiche['idVisiteur']) ?>/<?= urlencode($fiche['mois']) ?>/validate" 
    ...
    <a href="/index.php/fichefrais/<?= urlencode($fiche['idVisiteur']) ?>/<?= urlencode($fiche['mois']) ?>/edit">Modifier</a>
    
    <form action="/index.php/fichefrais/<?= urlencode($fiche['idVisiteur']) ?>/delete" method="post" style="display:inline" onsubmit="return confirm('Supprimer ?');">
