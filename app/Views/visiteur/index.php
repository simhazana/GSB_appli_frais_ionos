            ...
            <tbody>
                <?php foreach ($visiteur as $vis): ?>
                    <tr>
                        ...
                        <td class="actions">
                            <a href="/index.php/visiteur/<?= urlencode($vis['id']) ?>">Voir</a>
                            <a href="/index.php/visiteur/<?= urlencode($vis['id']) ?>/edit">Modifier</a>
                             <form action="/index.php/visiteur/<?= urlencode($vis['id']) ?>/delete"
                             method="post"
