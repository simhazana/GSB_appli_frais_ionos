...
<body>
    ...
    <a class="button" href="/index.php/fraisHorsForfait/create">➕ Ajouter un frais hors forfait</a>
                    ...
                    <tr>
                      <td><?= htmlspecialchars((string)$frais['id']) ?></td>
                        ...
                        <td><?= htmlspecialchars((string)$frais['date']) ?></td> 
                                     <td class="actions">
                            <a href="/index.php/fraisHorsForfait/<?= urlencode($frais['id']) ?>">Voir</a>
                            <a href="/index.php/fraisHorsForfait/<?= urlencode($frais['id']) ?>/edit">Modifier</a>
                             <form action="/index.php/fraisHorsForfait/<?= urlencode($frais['id']) ?>/delete"
                             method="post"
